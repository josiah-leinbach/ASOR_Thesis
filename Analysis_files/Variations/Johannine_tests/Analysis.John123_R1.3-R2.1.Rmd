...
```{r}
paul_pos.list <- readRDS("paul_9pos-plus.6test.rds")
paul_pos.list <- paul_pos.list[-c(14:16)]
...
## EM Algorithm: (1) R1 = 3, (2) R = 4, (3) POS = 9
```{r}
EMR <- EM(paul_pos.list, R1, d1, N, pi_reg, A, Alpha, Gamma_array, stateList, 0.001, 50)
saveRDS(EMR,"EMR.John123-R1.3-R2.1-9pos.rds")
```
