---
title: "EM Algorithm on R1 = 2 and R2 = 1 Regimes: 1 John"
...
# R1 = 2, R2 = 1, POS = 9, 7 Undisputed
```{r}
paul_pos.list <- readRDS("paul_9pos-plus.6test.rds")
paul_pos.list <- paul_pos.list[-c(14,15,16,18,19)]
...
saveRDS(EMR,"EMR.John1-R1.2-R2.1-9pos.rds")
```
