...
for (i in 1:length(seed.list)) {
  file.names[i] <- paste0("EMR_R1.1-R2.1_", seed.list[i], ".rds")
}

BIC_6pos_r1.1_r2.1 <- numeric(length(seed.list))
```
...
# Apply to matrix
r_list <- vector(mode = "list", length = 2)
