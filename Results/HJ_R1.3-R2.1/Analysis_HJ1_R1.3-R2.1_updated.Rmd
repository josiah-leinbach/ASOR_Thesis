...
for (i in 1:length(seed.list)) {
  file.names[i] <- paste0("EMR.HJ1-R1.3-R2.1_", seed.list[i], ".rds")
}

BIC.HJ1_6pos_r1.3_r2.1 <- numeric(length(seed.list))
```
...
BIC.HJ1_6pos_r1.3_r2.1[w] <- EMR$BIC
