...
for (i in 1:length(seed.list)) {
  file.names[i] <- paste0("EMR.HJ1-R1.2-R2.1_", seed.list[i], ".rds")
}

BIC.HJ1_6pos_r1.2_r2.1 <- numeric(length(seed.list))
```
...
BIC.HJ1_6pos_r1.2_r2.1[w] <- EMR$BIC
